...
function App() {
  ...
  const FORM_ENDPOINT =
    ...
    "https://formspree.io/f/your-form-id"; // override with VITE_FORMSPREE_ENDPOINT in .env
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      ...
      // save last active element and focus modal
      ...
      <main id="main-content" className="portfolio-shell">
          ...
          <motion.div className="hero-grid" variants={fadeUp}>
            ...
            >
              ...
              <p className="hero-card-summary">
                Passionate about MERN stack development, scalable web apps, and
                UI systems that feel sharp on every screen size.
              </p>
        ...
        >
          ...
          <div className="about-grid">
            <div className="about-card accent-card">
              ...
              <p>
                Build modern full-stack web experiences with polished
                interfaces, clear structure, and strong usability.
              </p>
            </div>
        ...
        >
          <div className="section-heading">
            ...
            <p>
              A compact showcase of product, frontend, and CMS work with
              practical value.
            </p>
          </div>
          ...
          {selectedProject && (
            ...
            >
              ...
              >
                ...
                <div className="modal-body" id="project-modal-desc">
